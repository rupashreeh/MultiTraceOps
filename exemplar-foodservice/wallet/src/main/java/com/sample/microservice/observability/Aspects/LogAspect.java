...
public class LogAspect {
  ...
  @Before("@annotation(com.sample.microservice.observability.annotation.Log)")
  ...
  @AfterReturning("@annotation(com.sample.microservice.observability.annotation.Log)")
  ...
  @Before("@annotation(com.sample.microservice.observability.annotation.Log) && execution(public * *(..))")
